    ...
    return (
        <div className="w-full h-full rounded-3xl relative flex">
            ...
            <>
                ...
                <div className="absolute left-5 top-[30%] w-[400px]  md:w-[350px] lg:w-[500px] xl:w-[600px] w-[200px] text-white">
                    <h2 className="font-bold text-4xl lg:text-6xl mb-5 text-sm">
                        {item.title}
                    </h2>
