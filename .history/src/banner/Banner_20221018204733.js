    ...
    return (
        <div className="w-full h-full relative flex">
            ...
            <>
                ...
                <div className="absolute left-5 top-[30%] w-[250px] md:w-[350px] lg:w-[500px] xl:w-[600px] sm:left-[5%]  text-white">
                    ...
                    <div className="flex items-center gap-x-3 items-center md:flex-wrap md:gap-y-5">
                        <button
