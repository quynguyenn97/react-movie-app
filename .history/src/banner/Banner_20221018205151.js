...
const Banner = () => {
    ...
    return (
        <section className="banner md:h-[600px] lg:h-[800px] mb-10">
            <Swiper
                grabCursor={"true"}
                spaceBetween={40}
                slidesPerView={"auto"}
...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full relative flex">
            ...
            />
            <>
                <div className="md:w-[250px] md:h-[400px] md:top-[15%] lg:w-[300px] lg:h-[500px] xl:w-[400px] xl:h-[600px] w-[200px] h-[400px] absolute right-[10%] top-[10%] lg:top-[12%] rounded-3xl z-10 hidden sm:block">
                    <img
                ...
                <div className="absolute left-5 top-[30%] w-[250px] md:w-[350px] lg:w-[500px] xl:w-[600px] sm:left-[5%]  text-white text-center">
                    <h2 className="font-bold text-4xl lg:text-6xl mb-5 text-4xl text-center">
                        {item.title}
                    </h2>
