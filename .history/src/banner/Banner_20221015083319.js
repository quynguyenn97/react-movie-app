...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full rounded-3xl relative flex">
            ...
            />
            <>
                <div className="md:w-[300px] md:h-[500px] w-[200px] h-[400px] absolute right-[10%] top-[10%] rounded-3xl z-10">
                    <img
                ...
                <div className="absolute left-5 top-[30%] md:w-[700px] w-[400px] text-white">
