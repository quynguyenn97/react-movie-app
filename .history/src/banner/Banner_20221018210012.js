...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full relative flex">
            ...
            />
            <>
                <div className="sm:block w-[200px] h-[400px] rounded-3xl z-10 hidden absolute right-[10%] top-[10%] md:w-[250px] md:h-[400px] md:top-[15%] lg:w-[300px] lg:h-[500px] xl:w-[400px] xl:h-[600px]   lg:top-[12%]  ">
                    <img
