...
const Banner = () => {
    ...
    return (
        <section className="banner h-[800px] mb-10 md:h-[600px] lg:h-[800px] ">
            <Swiper
                spaceBetween={30}
                centeredSlides={true}
                autoplay={{
    ...
    return (
        <div className="w-full h-full relative flex">
            ...
            <>
                ...
                <div className="absolute left-[10%] top-[20%] w-[300px] sm:left-[5%] md:w-[350px] lg:w-[500px] xl:w-[600px]   text-white ">
                    <h2 className="font-bold mb-5  text-4xl lg:text-6xl text-4xl">
                        {item.title}
                    </h2>
                    <p className="text-md mb-5 break-normal lg:text-xl ">
                        {item.overview}
                    </p>
                    <div className="flex flex-wrap gap-y-5 lg:items-center lg:gap-x-3 lg:items-center ">
                        <button
