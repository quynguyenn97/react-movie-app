...
const Banner = () => {
    ...
    return (
        <section className="banner h=[800px] md:h-[600px] lg:h-[800px] mb-10">
            <Swiper
                grabCursor={"true"}
                spaceBetween={40}
                slidesPerView={"auto"}
    ...
    return (
        <div className="w-full h-full relative flex">
            ...
            <>
                ...
                <div className="absolute left-[10%] top-[30%] w-[300px] md:w-[350px] lg:w-[500px] xl:w-[600px] sm:left-[5%]  text-white ">
                    <h2 className="font-bold text-4xl lg:text-6xl mb-5 text-4xl">
                        {item.title}
                    </h2>
