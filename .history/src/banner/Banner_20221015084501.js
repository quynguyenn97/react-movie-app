...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full rounded-3xl relative flex">
            ...
            />
            <>
                <div className="md:w-[250px] md:h-[400px] lg:w-[300px] lg:h-[500px] xl:w-[400px] xl:h-[600px] w-[200px] h-[400px] absolute right-[10%] top-[10%] md:top-[30%] lg:top-[20%] rounded-3xl z-10">
                    <img
