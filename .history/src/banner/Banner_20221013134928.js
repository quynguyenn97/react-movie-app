...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full rounded-lg relative flex">
            <div className="overlay absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.8)] to-[rgba(0,0,0,0.9)] rounded-lg"></div>
            <img
            ...
            />
            <>
                <div className="w-[400px] h-[600px] absolute right-[10%] top-[10%] rounded-3xl z-10">
                    <img
                        className="w-full h-full object-cover rounded-3xl"
                        src={tmdbAPI.imageOriginal(item.backdrop_path)}
                    />
                </div>
                <div className="absolute left-5 top-[30%] w-[700px] text-white">
