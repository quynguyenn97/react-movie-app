...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full rounded-3xl relative flex">
            ...
            />
            <>
                <div className="w-[400px] h-[600px] sm:w-[300px] sm:h-[500px] absolute right-[10%] top-[10%] rounded-3xl z-10">
                    <img
                ...
                <div className="absolute left-5 top-[30%] w-[700px] md:w-[500px] text-white">
