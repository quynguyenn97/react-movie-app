...
function BannerItem({ item }) {
    ...
    return (
        <div className="w-full h-full rounded-3xl relative flex">
            ...
            />
            <>
                <div className="md:w-[250px] md:h-[400px] lg:w-[300px] lg:h-[500px] xl:w-[400px] xl:h-[600px] w-[200px] h-[400px] absolute right-[10%] top-[10%] md:top-[30%] lg:top-[20%] rounded-3xl z-10 hidden">
                    <img
                ...
                <div className="absolute left-5 top-[30%]  md:w-[350px] lg:w-[500px] xl:w-[600px] w-[200px] text-white">
                    <h2 className="font-bold text-4xl lg:text-6xl mb-5">
                        {item.title}
                    </h2>
                    <p className="text-md lg:text-xl mb-5">{item.overview}</p>
