    ...
    return (
        <header>
            <div className="flex items-center justify-between page-container flex-wrap sm:flex-nowrap ">
                ...
                <div className="header flex items-center justify-end mr-0 md:mr-5 gap-x-2 md:gap-x-5 text-white py-10  text-2xl sm:text-2xl font-bold mx-auto sm:mx-0 mt-4 sm:mt-0">
                    <NavLink
                        to="/"
                        className={({ isActive }) =>
                            isActive ? "text-white" : ""
