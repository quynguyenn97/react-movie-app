    ...
    return (
        <header>
            <div className="flex items-center justify-between page-container">
                <div className="w-[70px] h-[50px] sm:w-[150px] sm:h-[100px] ">
                    <img
                ...
                <div className="header flex items-center justify-end mr-0 md:mr-5 gap-x-2 md:gap-x-5 text-white py-10  text-sm md:text-2xl font-bold">
                    <NavLink
                        to="/"
                        className={({ isActive }) =>
                            isActive ? "text-white" : ""
