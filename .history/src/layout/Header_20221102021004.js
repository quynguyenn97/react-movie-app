    ...
    return (
        <header
            ...
            <div className="flex flex-wrap sm:flex-nowrap">
                <div className="w-[250px] h-[50px] mx-auto mt-4 sm:w-[130px] sm:h-[60px] sm:mx-0 sm:mt-1 ">
                    <img
                ...
                <div className="flex mx-auto gap-x-2 text-xl py-5 sm:py-5  sm:text-[15px] sm:ml-6 md:gap-x-5 text-[#e5e5e5]">
                    <NavLink
                        end
                        to="/"
                        className={({ isActive }) =>
                ...
                <div className="sm:flex sm:ml-auto sm:gap-x-6 sm:items-center sm:relative hidden">
                    <div className="flex items-center left relative">
                        <input
                            className="left-input"
                            type="text"
                            placeholder="Title, genres, people"
                        />
                        <span className="absolute search">
                            <svg
                    ...
                    <div className="flex items-center gap-x-1 logo">
                        <div className="w-[35px] h-[35px] avatar-header bg-white rounded-md"></div>
                        <span className="logo">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
