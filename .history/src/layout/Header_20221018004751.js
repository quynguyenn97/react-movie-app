    ...
    return (
        <header className="fixed z-10 w-full">
            <div className="flex items-center sm:justify-between  flex-wrap sm:flex-nowrap">
                <div className="w-[250px] h-[50px] sm:w-[130px] sm:h-[50px] mx-auto sm:mx-0 mt-4 sm:mt-0">
                    <img
                ...
                <div className="header flex items-center sm:justify-end  md:mr-5 gap-x-2 md:gap-x-5 text-white py-5 sm:py-3  text-xl sm:text-2xl font-bold mx-auto">
                    <NavLink
                        to="/"
                        className={({ isActive }) =>
