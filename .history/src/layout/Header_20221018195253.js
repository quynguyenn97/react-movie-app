    ...
    return (
        <header
            ...
            <div className="flex flex-wrap sm:flex-nowrap">
                <div className="w-[250px] h-[50px] mx-auto mt-4 sm:w-[130px] sm:h-[60px] sm:mx-0 sm:mt-0 ">
                    <img
                ...
                <div className="flex mx-auto gap-x-2 md:gap-x-5 text-[#e5e5e5] py-5 sm:py-5 text-xl sm:text-[15px] sm:ml-6">
                    <NavLink
                        end
                        to="/"
                        className={({ isActive }) =>
                ...
                <div className="sm:flex sm:ml-auto sm:gap-x-6 sm:items-center sm:relative hidden">
                    <div className="flex itesm-center left relative">
                        <input
