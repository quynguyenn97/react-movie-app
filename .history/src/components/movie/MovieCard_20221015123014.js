...
const MovieCard = ({ item }) => {
    ...
    return (
        <div className="movie-card flex flex-col rounded-3xl p-3 bg-black w-[300px] sm:w-full h-full text-white select-none">
            <img
                src={tmdbAPI.image500(poster_path)}
                alt=""
                className="w-full h-[90%] object-cover rounded-3xl mb-2"
            />
