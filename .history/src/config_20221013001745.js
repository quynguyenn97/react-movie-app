...
export const tmdbAPI = {
    ...
    getTVDetails: (tvId) => `${tmdbEndpointSearchTV}/${tvId}?api_key=${apiKey}`,
    getTVMeta: (showId, type) =>
        `${tmdbEndpointSearchTV}/${showId}/${type}?api_key=${apiKey}`,
