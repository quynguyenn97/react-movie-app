...
const ShowPage = () => {
    ...
    return (
        <div className="pt-[150px] px-[20px] sm:py-10 md:py-20 page-container">
            ...
            <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-10 xl:grid-cols-8">
                {loading && (
