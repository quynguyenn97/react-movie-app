...
const HomePage = () => {
    return (
        <Fragment>
            <h2 className="text-white capitalize mb-5 text-2xl sm:text-3xl font-bold p-2 bg-[text-primary]">
                MOVIES:
            </h2>
            ...
            <h2 className="text-white capitalize mb-5 text-2xl sm:text-3xl font-bold">
                TV SHOWS:
            </h2>
            <section className="movies-layout page-container pb-20">
